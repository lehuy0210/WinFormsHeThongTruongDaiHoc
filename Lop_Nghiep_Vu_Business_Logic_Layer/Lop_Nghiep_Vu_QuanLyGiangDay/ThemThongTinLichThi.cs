...
{
    // ==================== CLASS CHỨC NĂNG THÊM LỊCH THI (BLL) ====================
    public class ChucNangThemLichThi
    {
        /// <summary>
        ...
        /// </summary>
        private bool KiemTraMaLichThiTonTai(List<ThongTinLichThi> danhSach, string maLichThi)
        {
            bool maRong = KiemTraChuoiRong(maLichThi);
            if (maRong)
                return false;

            foreach (ThongTinLichThi lt in danhSach)
            {
                string maLTHienTai = lt.MaLichThi;
        ...
        /// <summary>
        /// Thêm lịch thi mới vào danh sách
        /// </summary>
        public bool ThemLichThi(List<ThongTinLichThi> danhSach, ThongTinLichThi lichThiMoi)
        {
            if (lichThiMoi == null)
                return false;
            ...
            bool maTonTai = KiemTraMaLichThiTonTai(danhSach, lichThiMoi.MaLichThi);
