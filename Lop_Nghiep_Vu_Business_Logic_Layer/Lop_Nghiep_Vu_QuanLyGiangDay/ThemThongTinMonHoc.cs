...
{
    // ==================== CLASS CHỨC NĂNG THÊM MÔN HỌC (BLL) ====================
    public class ChucNangThemMonHoc
    {
        /// <summary>
        ...
        /// </summary>
        private bool KiemTraMaMonHocTonTai(List<ThongTinMonHoc> danhSach, string maMonHoc)
        {
            bool maRong = KiemTraChuoiRong(maMonHoc);
            if (maRong)
                return false;

            foreach (ThongTinMonHoc mh in danhSach)
            {
                string maMHHienTai = mh.MaMonHoc;
        ...
        /// </summary>
        public bool ThemMonHoc(List<ThongTinMonHoc> danhSach, ThongTinMonHoc monHocMoi)
        {
            if (monHocMoi == null)
                return false;
            ...
            bool maTonTai = KiemTraMaMonHocTonTai(danhSach, monHocMoi.MaMonHoc);
