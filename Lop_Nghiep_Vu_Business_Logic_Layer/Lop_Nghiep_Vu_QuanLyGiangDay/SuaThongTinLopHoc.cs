...
{
    // ==================== CLASS CHỨC NĂNG SỬA LỚP HỌC (BLL) ====================
    public class ChucNangSuaLopHoc
    {
        /// <summary>
        ...
        /// <summary>
        /// Tìm vị trí lớp học theo mã
        /// </summary>
        private int TimViTriLopHoc(List<ThongTinLopHoc> danhSach, string maLopHoc)
        {
            ...
            {
                string maLHHienTai = danhSach[i].MaLopHoc;
        ...
        /// </summary>
        public bool SuaLopHoc(List<ThongTinLopHoc> danhSach, string maLopHoc, ThongTinLopHoc lopHocMoi)
        {
            if (danhSach == null || lopHocMoi == null)
                return false;

            int viTri = TimViTriLopHoc(danhSach, maLopHoc);
