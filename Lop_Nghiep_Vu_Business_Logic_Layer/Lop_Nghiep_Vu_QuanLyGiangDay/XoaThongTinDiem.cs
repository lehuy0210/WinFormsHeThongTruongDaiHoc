...
{
    // ==================== CLASS CHỨC NĂNG XÓA ĐIỂM (BLL) ====================
    public class ChucNangXoaDiem
    {
        /// <summary>
        ...
        /// <summary>
        /// Xóa điểm theo mã sinh viên và mã môn học
        /// </summary>
        public bool XoaDiem(List<ThongTinDiem> danhSach, string maSV, string maMonHoc)
        {
            if (danhSach == null)
                return false;
