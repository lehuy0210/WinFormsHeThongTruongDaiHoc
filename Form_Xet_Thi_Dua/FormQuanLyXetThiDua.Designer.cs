...
{
    partial class FormQuanLyXetThiDua
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtTimKiem = new TextBox
            {
                ...
                PlaceholderText = "Nhập mã SV hoặc GV..."
            };

            // ComboBox Loại đối tượng
            cboLoaiDoiTuong = new ComboBox
            {
                Location = new Point(150, 60),
                Size = new Size(200, 23),
                DropDownStyle = ComboBoxStyle.DropDownList
            };
            cboLoaiDoiTuong.Items.AddRange(new object[] {
                "-- Tất cả --",
                "Sinh viên",
                "Giảng viên"
            });
